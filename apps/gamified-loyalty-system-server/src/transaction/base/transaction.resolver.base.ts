...
export class TransactionResolverBase {
  ...
  async createTransaction(
    ...
    return await this.service.createTransaction({
      ...
      data: {
        ...
        coffeeshop: args.data.coffeeshop
          ? {
              connect: args.data.coffeeshop,
            }
          : undefined,
  ...
  async getAdmin(@graphql.Parent() parent: Transaction): Promise<Admin | null> {
  ...
  @graphql.ResolveField(() => Coffeeshop, {
    nullable: true,
    name: "coffeeshop",
  })
  async getCoffeeshop(
    ...
    const result = await this.service.getCoffeeshop(parent.id);
