...
@InputType()
class RewardCreateNestedManyWithoutCoffeeshopsInput {
...
export { RewardCreateNestedManyWithoutCoffeeshopsInput as RewardCreateNestedManyWithoutCoffeeshopsInput };
